...
#------------------------------------------------------------------------------#
## _cmd2_script_dir ##
# Make script_cmd_dir Directory, pass var script_cmd_dir
  _cmd2_script_dir() {
...
#------------------------------------------------------------------------------#
## _cmd2_scripts_gen ##
# Generate cmdswitch2 script from ${_list0} array, pass var _cmd_script
  _cmd2_scripts_gen() {
...
#------------------------------------------------------------------------------#
## _cmd2_script_perms ##
# Set ownership and permissions on cmdswitch2 script, Pass var _cmd_script
  _cmd2_script_perms() {
...
#------------------------------------------------------------------------------#
## _cmd2_script_sym ##
# Create symbolic link to system bin folder, Pass var _cmd_script
  _cmd2_script_sym() {
...
# Set ownership and permission on symbolic link in system bin folder, Pass var _cmd_script
  _cmd2_script_sym_per() {
